...
public class User {
	...
	public User(int user_no, int grade_no, String user_id, String user_pw, String user_name, String user_phone,
			String user_email, String user_addr, String user_question, String user_answer, int user_warn,
	...
	public String toString() {
		return "User [user_no=" + user_no + ", grade_no=" + grade_no + ", user_id=" + user_id + ", user_pw=" + user_pw
				...
				+ ", user_addr=" + user_addr + ", user_question=" + user_question + ", user_answer=" + user_answer
				+ ", user_warn=" + user_warn + ", reg_date=" + reg_date + "]";
	}
