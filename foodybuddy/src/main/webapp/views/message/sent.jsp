...
<body>
        ...
        <div class="container" style="padding-left: 0%; height:90%;">
            ...
            <li >
            	<div style="background-color: aliceblue ;">
            		<a href="/msgSent" style="color: black; font-weight : bold;">
            		보낸쪽지
            		</a>
            	</div>
            </li>
		 ...
		 <% int index = 1; %>
            <% for (Map<String, Object> message : messages) { %>
                ...
                <td></td>
                    ...
                    <td onclick="showMessage();" style="cursor: pointer;"><%= message.get("message_title") %></td>
    ...
    function showMessage() {
        ...
        <% for (Map<String, Object> message : messages) { %>
            var receiverName = "<%= message.get("receiverName") %>";
            var messageTitle = "<%= message.get("message_title")%>"
            var messageText = "<%= message.get("message_text") %>";
            var sentAt = "<%= ((LocalDateTime) message.get("sent_at")).toString() %>";
            
            temp += "<h1>받은 쪽지</h1><br>";
            temp += "보낸 사람: " + receiverName + "<br>";
            temp += "제목: "+messageTitle+"<br>";
            temp += "내용: "+messageText + "<br>";
